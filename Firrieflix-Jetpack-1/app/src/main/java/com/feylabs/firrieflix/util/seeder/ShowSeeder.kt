...
object ShowSeeder {
    ...
    fun showSeeder(): MutableList<MovieModel> {
        ...
        tempList.add(
            MovieModel(
                ...
                type = MovieModel.MovieType.SHOW,
                ...
                releaseDate = "2017",
                artist = arrayListOf(
                    MovieModel.Artist("", "Úrsula Corberó", play_as = "Tokyo (Silene Oliveira)",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/wZkK15LnloSAhzs1jxI3AZbR6f0.jpg"),
                    MovieModel.Artist("", "Álvaro Morte", play_as = "El Profesor",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/2TGPhdpRC5wjdFEJqnLYiN5kbwg.jpg"),
                    MovieModel.Artist("", "Alba Flores", play_as = "Nairobi",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/vWUZkQKxj63qTNBa8DvEd0CpU64.jpg"),
                ),
                director = "Álex Pina",
                imbdRating = "83",
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2020",
                artist = arrayListOf(
                    MovieModel.Artist("", "Anya Taylor-Joy", play_as = "Elizabeth 'Beth' Harmon",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/wA1ZT3GSWvRjcJP96VRRARs9zEe.jpg"),
                ),
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2005",
                artist = arrayListOf(
                    MovieModel.Artist("", "Jessie Flower", play_as = "Toph Beifong (voice)",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/wAq18B8phzkvqJY16CP47Ygt7hV.jpg"),
                    MovieModel.Artist("", "Zach Tyler", play_as = "Aang (voice)",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/wXHCem1HhV4h5uW1DzAUYVOVZoQ.jpg"),
                ),
            ...
            MovieModel(
                ...
                artist = arrayListOf(
                    MovieModel.Artist(
                        ...
                        "Fionn Whitehead",
                        play_as = "Tommy",
                        img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/9f3yMfRcrdFRausgBVQVzrlitsi.jpg"
                    ),
        ...
        tempList.add(
            MovieModel(
                ...
                artist = arrayListOf(
                    MovieModel.Artist("", "Dan Castellaneta", play_as = "Homer Simpson",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/AmeqWhP4A46AWkM4kVphg6jOTQX.jpg"),
                ),
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2011",
                artist = arrayListOf(
                    MovieModel.Artist("", "Emilia Clarke", play_as = "Daenerys Targaryen",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/86jeYFV40KctQMDQIWhJ5oviNGj.jpg"),
                ),
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2021",
                artist = arrayListOf(
                    MovieModel.Artist("", "Laura Donnelly", play_as = "Amalia True",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/tle0V2j3uu9egn0OZKluzYb3F7l.jpg"),
                    ),
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2005",
                artist = arrayListOf(
                    MovieModel.Artist("", "Jim Ward", play_as = "Diamondhead",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/yQklzBUmaHbcS00DXq73J1HYUrE.jpg"),
                ),
                director = "Joe Kelly",
                imbdRating = "81",
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2004",
                artist = arrayListOf(
                    MovieModel.Artist("", "Naveen Andrews", play_as = "Sayid Jarrah",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/tVAQ4dP9rRosjHZBLNVlfAGVE66.jpg"),
                    MovieModel.Artist("", "Yunjin Kim", play_as = "Sun-Hwa Kwon",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/xS7eco56mUiZGJGWDZ0pwzrUAei.jpg"),
                ),
                director = "J.J. Abrams",
                imbdRating = "79",
        ...
        tempList.add(
            MovieModel(
                ...
                releaseDate = "2014",
                artist = arrayListOf(
                    MovieModel.Artist("", "Lindsey Morgans", play_as = "Raven Reyes",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/fl1Jt9brtTV6vfNl5mv55SrSCZm.jpg"),
                    MovieModel.Artist("", "Christopher Larkin", play_as = "Monty Green",img_link = "https://www.themoviedb.org/t/p/w138_and_h175_face/vuFngjTpYHjbo5llQcFPnAPM3jz.jpg"),
                ),
